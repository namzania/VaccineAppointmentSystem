...
<html>
				...
				<div class="container"><br>
					...
					<div class="row">
						<div class="booking-form">
							...
							<form name="LogInPatient" action="PatientController?action=LoginPatient" method="post">
								<div class="row">
									<div class="col-md-5">
										<div class="form-group">
											<span class="form-label" style="margin-left:60%;">Email</span>
											<input type="text" name="PatientEmail" id="PatientEmail" required>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-5">
										<div class="form-group">
											...
											<input type="password" id="PatientPassword" name="PatientPassword" id="PatientPassword" required>
								...
								<div class="form-btn">
									...
									<a style="background-color:rgba(133, 104, 73, 0.9);color: white;padding: 14px 25px;text-align: center;text-decoration: none;display: inline-block;border-radius:40px;height: 55px;width: 100%;margin-left:-1px;font-weight: 700;font-size: 18px;" href="SignUpPatient.jsp">Sign Up</a>
								</div>
							</form>
						</div>
					</div>
	...
	<!--<body>
		<div class="container" style="margin:auto; max-width:15%;">
			<form name="LogInPatient" action="PatientController?action=LoginPatient" method="post">
				Email:
				<input type="text" name="PatientEmail" id="PatientEmail" required><br><br>
				Password:
				<input type="password" name="PatientPassword" id="PatientPassword" required><br><br>
