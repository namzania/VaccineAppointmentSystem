...
<html>
	<head>
		...
		<title>Update Profile | Staff</title>
	</head>
	<style>
			input
			{	
				...
				<div class="container">
					...
					<div class="row">
						<div class="booking-form">
							...
							<form name="ManageProfileStaff" action="StaffController?action=ManageProfile" method="post">
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<span class="form-label">Staff ID</span>
											<input type="text" name="StaffID" id="StaffID" value="<c:out value="${staff.staffID}" />"readonly>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<span class="form-label">Name</span>
											<input type="text" name="StaffName" id="StaffName" value="<c:out value="${staff.staffName}" />" readonly>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="email" name="StaffEmail" value="<c:out value="${staff.staffEmail}" />" required>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<span class="form-label">Password</span>
											<input type="password" id="StaffPassword" name="StaffPassword" value="<c:out value="${staff.staffPassword}" />" required>
	...
	<!-- <body>
		<form name="ManageProfileStaff" action="StaffController?action=ManageProfile" method="post">
			...
			<input type="email" name="StaffEmail" value="<c:out value="${staff.staffEmail}" />" required>
			Password:
			<input type="password" name="StaffPassword" value="<c:out value="${staff.staffPassword}" />" required>
			<br><br>
