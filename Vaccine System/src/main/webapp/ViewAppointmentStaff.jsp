...
<html>
	<head>
		...
		<title>List of Appointments | Staff</title>
	</head>
	<style>
		#t1
		{
	...
	<body style="background:rgba(133, 104, 73, 0.33);">
		<ul>	
 		...
 		<div class="content">
   		 	<div class="container">
   		 		<input type="text" id="SearchInput" onkeyup="Search()" value="2022-">
   		 		<div style="float:right;font-family:Times New Roman;font-size:20px;font-weight:bold;"><i class="fa fa-search"></i>&nbsp;Search Appointment:&nbsp;</div><br><br>
     			<h2 id="t3">List of Appointments</h2>
         			 	...
         			 	<tbody>
         			 		<c:forEach items="${appointments}" var="appointment">
	            				...
	            				<tr>
	              					...
	              					<td id="t1"><c:out value="${appointment.patientID}"/></td>
