				...
				<div class="container">
					...
					<div class="row">
						<div class="booking-form">
							...
							<form name="SignUpStaff" action="StaffController?action=AddStaff" method="post">
								<div class="row">
									<div class="col-md-6">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="checkbox" onclick="showPassword()" style="margin-left:-90px;">
										</div>
									</div>
								</div>
								<div class="form-btn">
									<button class="submit-btn">Sign Up</button><br>
									<a style="background-color:rgba(133, 104, 73, 0.9);color: white;padding: 14px 25px;text-align: center;text-decoration: none;display: inline-block;border-radius:40px;height: 55px;width: 100%;margin-left:-1px;font-weight: 700;font-size: 18px;" href="LoginStaff.jsp">Login</a>
								</div>
							</form>
						</div>
					</div>
